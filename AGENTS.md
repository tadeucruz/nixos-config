...
modules/
  ...
  development-mac.nix            # normandy-only: dock persistent-apps, displayplacer/Xcode postActivation script
...
homebrew/                        # Homebrew has no home-manager equivalent, so it's not under modules/ or home/
  ...
  development-mac.nix            # normandy-only casks/brews/masApps (android-studio, flutter, cocoapods, Xcode, ...)
hosts/
